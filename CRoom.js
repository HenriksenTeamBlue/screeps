...
CRoom.prototype.askForReinforcements = function() {
	console.log(this.room.name + ': ask for reinforcements.');
	this.roomHandler.requestReinforcement(this);
};

CRoom.prototype.sendReinforcements = function(room) {
...
CRoom.prototype.distributeBuilders = function() {
...
CRoom.prototype.distributeCarriers = function() {
	var counter = 0;
	var builders = [];
	var carriers = [];
	for(var i = 0; i < this.creeps.length; i++) {
...
CRoom.prototype.distributeResources = function(type) {
